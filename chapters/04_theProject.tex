...
\begin{figure}[ht]
    \centering
    \includegraphics[width =\textwidth]{mainmenu.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width =\textwidth]{classroom.jpg}
...
\end{itemize}
\noindent
The UI will be built using MUI\footnote{\url{https://mui.com}}, along with a free template provided by them.\\
