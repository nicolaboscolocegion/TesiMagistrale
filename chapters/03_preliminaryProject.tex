...
One challenge for this application is having a correctly multiplayer session between \ac{HMD}, unfortunately \ac{UE} does not provide a \verb|VRpawn| that has multiplayer functionality.
...
\end{itemize}
\noindent
But we can also create custom events with Blueprint or \cpp, they can be triggered whenever we want, they can also be replicated in clients in multiplayer sessions. 
